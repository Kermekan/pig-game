...
const closeModl = document.querySelector('.closebtn');
...
btnRoll.addEventListener('click', function (e) {
    if (playing) {
        ...
        // 2. Disply dice number
        diceEl.classList.remove('hidden');
        diceEl.src = `dice-${dice}.png`;
        
        // 3. Check if 1 is rolled: if true, switch to next player
        if (dice !== 1) {
...
btnRules.addEventListener('click', _ => {
    containerRules.style.display = 'grid';
});
